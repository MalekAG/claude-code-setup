...
- **Session continuity system** — context orchestrator, handoff hooks, and related scripts (advanced feature, separate setup)
- **npx skills** — `find-skills`, `supabase-postgres-best-practices`, `vercel-deploy` (install via Claude Code plugin system)
- **Per-project memory** — auto-generated by Claude Code per machine
- **Credentials and API keys** — you'll need to configure your own (see [docs/SKILLS-CATALOG.md](docs/SKILLS-CATALOG.md) for which skills need what)
